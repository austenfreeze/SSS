      ...
      <aside className="w-64 border-r border-zinc-800 p-6 flex flex-col gap-8">
        <div>
          ...
          <nav className="flex flex-col gap-2">
            <Link href="/admin/manage" className="text-sm hover:text-white text-zinc-400">Manage Archive</Link>
            <Link href="/studio" className="text-sm hover:text-white text-zinc-400">Open Studio</Link>
          </nav>
        </div>
